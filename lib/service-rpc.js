...
var ArqmaServiceRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof ArqmaServiceRPC)) return new ArqmaServiceRPC(opts)
...
ArqmaServiceRPC.prototype.reset = function (opts) {
...
ArqmaServiceRPC.prototype.save = function () {
  return new Promise((resolve, reject) => {
...
ArqmaServiceRPC.prototype.getViewKey = function () {
  return new Promise((resolve, reject) => {
...
ArqmaServiceRPC.prototype.getSpendKeys = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.getMnemonicSeed = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
ArqmaServiceRPC.prototype.getStatus = function () {
  return new Promise((resolve, reject) => {
...
ArqmaServiceRPC.prototype.getAddresses = function () {
  return new Promise((resolve, reject) => {
...
ArqmaServiceRPC.prototype.createAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.deleteAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
ArqmaServiceRPC.prototype.getBalance = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
ArqmaServiceRPC.prototype.getBlockHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.getTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
    opts.blockHash = opts.blockHash || false
...
ArqmaServiceRPC.prototype.getUnconfirmedTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
...
ArqmaServiceRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.newTransfer = function (address, amount) {
  return {
    address: address,
...
ArqmaServiceRPC.prototype.sendTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    var that = this
    opts = opts || {}
    opts.addresses = opts.addresses = []
...
ArqmaServiceRPC.prototype.createDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses = []
    opts.transfers = opts.transfers || false
...
ArqmaServiceRPC.prototype.getDelayedTransactionHashes = function () {
  return new Promise((resolve, reject) => {
...
ArqmaServiceRPC.prototype.deleteDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.sendDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.transactionHash = opts.transactionHash || false
...
ArqmaServiceRPC.prototype.sendFusionTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.estimateFusion = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.threshold = opts.threshold || this.defaultFusionThreshold
    opts.addresses = opts.addresses || []
...
ArqmaServiceRPC.prototype.createIntegratedAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaServiceRPC.prototype.getFeeInfo = function () {
  return this.getNodeFeeInfo()
}

ArqmaServiceRPC.prototype.getNodeFeeInfo = function () {
  return new Promise((resolve, reject) => {
...
ArqmaServiceRPC.prototype._postToWalletd = function (method, params) {
  return new Promise((resolve, reject) => {
...
module.exports = ArqmaServiceRPC

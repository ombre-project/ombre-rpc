...
var ArqmaRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof ArqmaRPC)) return new ArqmaRPC(opts)
...
ArqmaRPC.prototype.getBlocks = function (opts) {
...
ArqmaRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
ArqmaRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
ArqmaRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
ArqmaRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
ArqmaRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.getHeight = function () {
  return this.height()
}

ArqmaRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.getInfo = function () {
  return this.info()
}

ArqmaRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.feeInfo = function () {
  return this.fee()
}

ArqmaRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getPeers = function () {
  return this.peers()
}

ArqmaRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getWalletSyncData = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getGlobalIndexesForRange = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getTransactionsStatus = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getBlocks = function (opts) { // getblocks
...
ArqmaRPC.prototype.queryBlocks = function (opts) { // queryblocks
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    return reject(new Error('This RPC call is not implemented'))
  })
...
ArqmaRPC.prototype.queryBlocksDetailed = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.queryBlocksLite = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
ArqmaRPC.prototype.getIndexes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getRandomOutputs = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getPoolChanges = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getPoolChangesLite = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (opts.tailBlockHash === undefined) return reject(new Error('must supply a tail block hash'))
    if (!Array.isArray(opts.knownTransactionHashes)) return reject(new Error('must supply an array of known transaction hashes'))
...
ArqmaRPC.prototype.getBlockDetailsByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getBlocksDetailsByHeights = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getBlocksDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
ArqmaRPC.prototype.getBlocksHashesByTimestamps = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getTransactionDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype.getTransactionHashesByPaymentId = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ArqmaRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
ArqmaRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
ArqmaRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {

...
var ombreRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof ombreRPC)) return new ombreRPC(opts)
  this.host = opts.host || '127.0.0.1'
  this.port = opts.port || 19994
  this.timeout = opts.timeout || 2000
  this.ssl = opts.ssl || false
}

ombreRPC.prototype.getBlocks = function (opts) {
...
ombreRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
ombreRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
ombreRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
ombreRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
ombreRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype.getHeight = function () {
  return this.height()
}

ombreRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype.getInfo = function () {
  return this.info()
}

ombreRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype.feeInfo = function () {
  return this.fee()
}

ombreRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getPeers = function () {
  return this.peers()
}

ombreRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
    this._rawPost('get_peer_list', {}).then((result) => {
      return resolve(result)
    }).catch((err) => {
      return reject(err)
    })
...
ombreRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getWalletSyncData = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getGlobalIndexesForRange = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getTransactionsStatus = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getBlocks = function (opts) { // getblocks
...
ombreRPC.prototype.queryBlocks = function (opts) { // queryblocks
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    return reject(new Error('This RPC call is not implemented'))
  })
...
ombreRPC.prototype.queryBlocksDetailed = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.queryBlocksLite = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
ombreRPC.prototype.getIndexes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getRandomOutputs = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getPoolChanges = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getPoolChangesLite = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (opts.tailBlockHash === undefined) return reject(new Error('must supply a tail block hash'))
    if (!Array.isArray(opts.knownTransactionHashes)) return reject(new Error('must supply an array of known transaction hashes'))
...
ombreRPC.prototype.getBlockDetailsByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getBlocksDetailsByHeights = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getBlocksDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
ombreRPC.prototype.getBlocksHashesByTimestamps = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getTransactionDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype.getTransactionHashesByPaymentId = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
ombreRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
ombreRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
ombreRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {
